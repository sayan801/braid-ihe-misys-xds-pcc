...
/** The description of an sudit trail connection.
 * 
 *
...
public class AuditTrailDescription {
	...
	private String applicationName = "MisysConnect";
	private String alternateName;
	private String enterpriseSiteId;
	private String auditSourceId;
	
	private String auditTrailType = LOG4J;
	private Identifier defaultAssigningAuthority;
	private Identifier defaultLocalAssigningAuthority;
	private String defaultIdEncoding;
	private String defaultNameEncoding;
	private String defaultDocumentIdType;

	private String remoteHostname;
	private int remotePort;
	private String remoteType;
	
	/** Generate a new audit trail description.
	 * 
	 ...
	 * <dd>The name of the application, MisysConnect by default.</dd>
	 ...
	 * <dt>Set: ParticipantObject Entry: DocumentIdType</dt>
	 * <dd>The encoding to use for the document.  Default is to not use the document id.  Add "DocumentId" or something to enable it.</dd>
	 * </dl>
	 * 
	 * An asigning autority can also be given.
	 * The assigning authority is to retrieve ids for this audit trail's messages.  Uses  if none given.
	 */
	public AuditTrailDescription(IConnectionDescription auditRepository) {
		...
		defaultDocumentIdType = set.getValue("DocumentIdType");
		defaultAssigningAuthority = auditRepository.getIdentifier("AssigningAuthority");
		defaultLocalAssigningAuthority = auditRepository.getIdentifier("LocalAssigningAuthority");
	}
	...
	public Identifier getAsigningAuthority() {
		return defaultAssigningAuthority;
	}
	
	public Identifier getLocalAsigningAuthority() {
		return defaultLocalAssigningAuthority;
	}
