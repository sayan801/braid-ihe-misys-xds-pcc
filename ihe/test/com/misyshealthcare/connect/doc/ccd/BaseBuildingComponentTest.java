...
public class BaseBuildingComponentTest extends TestCase {
	  ...
	  public void testBuildMedication() {
	      ...
	      medications[0] = new Medication("Amoxicillin (250 mg tabs)", new GregorianCalendar(), null, new Code("472.0", null, "ICD9", null), "3 times per day  ora", 
	    		  new Code("14735", null, "RouteOfAdministration", null), new DoseQuantity(new Quantity("1", "tablet"), null), "t.i.d", null, "", null, "active", null);
	      boolean required = true;
