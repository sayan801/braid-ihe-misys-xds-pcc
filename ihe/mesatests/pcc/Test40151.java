...
import com.misyshealthcare.connect.doc.ccd.EDReferralBuilder;
...
/**
 * Create a XD-MS ED Referral Sample
 * 
 * @author Wenzhi Li
 * @version 1.0, Jan 13, 2009
 */
public class Test40151 extends TestPCCData {
	   public static void main(String[] args) {
		   String ssn = "123-45-678";
		   ssn = ssn.replaceAll("-", "");
		   
		   MesaTestLogger log = new MesaTestLogger(System.out);
	        log.writeTestBegin("40151");
	    	TestKit.configActor(log, "xdsnist");

	        String outputFile = "c:\\temp\\pcctest\\EHR_ALLSCRIPTS_CONNECT_40151.xml";
	    	try {	
...
//	            data.setPlanOfCares(getPlanOfCare());
	              ...
	              data.setProposedDisposition(getProposedDisposition());
	              data.setTransportMode(getTransportMode());
	            EDReferralBuilder builder = new EDReferralBuilder(data);
