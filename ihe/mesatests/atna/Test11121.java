 ...
 */
public class Test11121 {
	
	/**
	 * Run MESA Test patient.
	 * This test only runs Patient Access. To get other two Audit Record messages,
	 * run Test11101, 11103 or 11104. 
	 */
	public static void main(String[] args) {
		...
		IheAuditTrail snat = new IheAuditTrail("PdqConsumer", repositories);
		snat.start();
		snat.recordAccessed(patient);
