...
/** Test rig for MESA test 11102.
 * 
 * This tests the basic Reliable logging capabilities.
...
public class Test11102 {
	...
	public static void main(String[] args) {
		...
		repositories.add(ConnectionFactory.getConnectionDescription("log4j_audittrail")); // needs to be reliable connection.
