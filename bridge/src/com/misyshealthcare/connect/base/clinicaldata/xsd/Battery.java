 ...
 *  Battery bean class
 */
public class Battery extends com.misyshealthcare.connect.base.clinicaldata.xsd.TestBase
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":Battery", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "Battery", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static Battery parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Battery".equals(type)) {
                            ...
                            return (Battery) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list6.add(com.misyshealthcare.connect.base.clinicaldata.xsd.Test.Factory.parse(
                                reader));
                    }
