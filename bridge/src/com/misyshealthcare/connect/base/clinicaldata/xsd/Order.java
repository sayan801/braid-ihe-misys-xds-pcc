 ...
 *  Order bean class
 */
public class Order implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Orderid
     */
        ...
        if (localProviderTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "provider", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "provider");
                }
            } else {
    ...
    public static class Factory {
         ...
         */
        public static Order parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Order".equals(type)) {
                            ...
                            return (Order) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
