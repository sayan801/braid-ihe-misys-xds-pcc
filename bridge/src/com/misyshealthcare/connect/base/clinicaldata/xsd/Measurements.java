...
/**
 *  Measurements bean class
 */
public class Measurements implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Code
     */
    ...
    /**
     * field for EntryDateTime
     */
    protected java.util.Calendar localEntryDateTime;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localEntryDateTimeTracker = false;
     ...
     *   in the serialized XML
     */
    protected boolean localUnitOfMeasureTracker = false;
    ...
    public java.util.Calendar getEntryDateTime() {
        return localEntryDateTime;
    }

    /**
     * Auto generated setter method
     * @param param EntryDateTime
     */
    public void setEntryDateTime(java.util.Calendar param) {
        if (param != null) {
            //update the setting tracker
            localEntryDateTimeTracker = true;
        } else {
            localEntryDateTimeTracker = true;
        }

        this.localEntryDateTime = param;
    }
    ...
    /**
     * Auto generated setter method
     * @param param UnitOfMeasure
     */
    public void setUnitOfMeasure(java.lang.String param) {
        if (param != null) {
            //update the setting tracker
            localUnitOfMeasureTracker = true;
        } else {
            localUnitOfMeasureTracker = true;
        }

        this.localUnitOfMeasure = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Measurements.this.serialize(parentQName, factory, xmlWriter);
                }
            };
            ...
            if (localCodes != null) {
                for (int i = 0; i < localCodes.length; i++) {
                    if (localCodes[i] != null) {
                        localCodes[i].serialize(new javax.xml.namespace.QName(
                                "http://clinicaldata.base.connect.misyshealthcare.com/xsd",
                                "codes"), factory, xmlWriter);
                    } else {
                        ...
                        if (!namespace2.equals("")) {
                            ...
                            if (prefix2 == null) {
                                ...
                                xmlWriter.writeStartElement(prefix2, "codes",
                                    namespace2);
                                xmlWriter.writeNamespace(prefix2, namespace2);
                                xmlWriter.setPrefix(prefix2, namespace2);
                            } else {
        ...
        if (localEntryDateTimeTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "entryDateTime",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "entryDateTime");
                }
            } else {
                xmlWriter.writeStartElement("entryDateTime");
            }

            if (localEntryDateTime == null) {
                // write the nil attribute
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "nil", "1",
                    xmlWriter);
        ...
        if (localUnitOfMeasureTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "unitOfMeasure",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "unitOfMeasure");
                }
            } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localEntryDateTimeTracker) {
            ...
            elementList.add((localEntryDateTime == null) ? null
                                                         : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localEntryDateTime));
        }
        ...
        if (localUnitOfMeasureTracker) {
            ...
            elementList.add((localUnitOfMeasure == null) ? null
                                                         : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localUnitOfMeasure));
        }
    ...
    public static class Factory {
         ...
         */
        public static Measurements parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Measurements object = new Measurements();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Measurements".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Measurements) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list2.add(com.misyshealthcare.connect.base.clinicaldata.xsd.Code.Factory.parse(
                                reader));
                    }
                    ...
                    object.setCodes((com.misyshealthcare.connect.base.clinicaldata.xsd.Code[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            com.misyshealthcare.connect.base.clinicaldata.xsd.Code.class,
                            list2));
                } // End of if for expected property start element
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://clinicaldata.base.connect.misyshealthcare.com/xsd",
                            "entryDateTime").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setEntryDateTime(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://clinicaldata.base.connect.misyshealthcare.com/xsd",
                            "unitOfMeasure").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setUnitOfMeasure(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
