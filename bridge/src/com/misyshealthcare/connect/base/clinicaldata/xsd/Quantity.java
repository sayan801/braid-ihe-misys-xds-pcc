 ...
 *  Quantity bean class
 */
public class Quantity implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Unit
     */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Quantity.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static Quantity parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Quantity object = new Quantity();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Quantity".equals(type)) {
                            ...
                            return (Quantity) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
