...
/**
 *  Performer bean class
 */
public class Performer extends com.misyshealthcare.connect.doc.ccd.xsd.Participant
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Code
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem localCode;
     ...
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem localFunctionCode;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localFunctionCodeTracker = false;
     ...
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem getCode() {
        return localCode;
    }
     ...
     * @return com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem getFunctionCode() {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Performer.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":Performer", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "Performer", xmlWriter);
        }
        ...
        if (localIdTracker) {
            if (localId == null) {
                ...
                localId.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd", "id"),
                    factory, xmlWriter);
            }
        }
        ...
        if (localPhoneNumbersTracker) {
            if (localPhoneNumbers != null) {
                for (int i = 0; i < localPhoneNumbers.length; i++) {
                    if (localPhoneNumbers[i] != null) {
                        localPhoneNumbers[i].serialize(new javax.xml.namespace.QName(
                                "http://ccd.doc.connect.misyshealthcare.com/xsd",
                                "phoneNumbers"), factory, xmlWriter);
                    } else {
                        // write null attribute
                        java.lang.String namespace2 = "http://ccd.doc.connect.misyshealthcare.com/xsd";
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "phoneNumbers",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2, "phoneNumbers");
                    }
                } else {
                    xmlWriter.writeStartElement("phoneNumbers");
                }
        ...
        if (localCodeTracker) {
            if (localCode == null) {
                ...
                localCode.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd", "code"),
                    factory, xmlWriter);
            }
        }
            ...
            if (localFunctionCode == null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "functionCode",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2, "functionCode");
                    }
                } else {
                    xmlWriter.writeStartElement("functionCode");
                }
                ...
                localFunctionCode.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd",
                        "functionCode"), factory, xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName(
                "http://ccd.doc.connect.misyshealthcare.com/xsd", "Performer"));
        ...
        if (localPhoneNumbersTracker) {
            if (localPhoneNumbers != null) {
                for (int i = 0; i < localPhoneNumbers.length; i++) {
                    if (localPhoneNumbers[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "http://ccd.doc.connect.misyshealthcare.com/xsd",
                                "phoneNumbers"));
                        elementList.add(localPhoneNumbers[i]);
                    } else {
                        elementList.add(new javax.xml.namespace.QName(
                                "http://ccd.doc.connect.misyshealthcare.com/xsd",
                                "phoneNumbers"));
                ...
                elementList.add(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd",
                        "phoneNumbers"));
                elementList.add(localPhoneNumbers);
            }
        }
        ...
        if (localFunctionCodeTracker) {
            ...
            elementList.add((localFunctionCode == null) ? null : localFunctionCode);
        }
    ...
    public static class Factory {
         ...
         */
        public static Performer parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Performer object = new Performer();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Performer".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Performer) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setId(com.misyshealthcare.connect.doc.ccd.xsd.Id.Factory.parse(
                                reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "phoneNumbers").equals(reader.getName())) {
                    // Process the array and step past its final element's end.
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list4.add(com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber.Factory.parse(
                                reader));
                    }
                    ...
                    // call the converter utility  to convert and set the array
                    object.setPhoneNumbers((com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setCode(com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem.Factory.parse(
                                reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "functionCode").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");

                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        object.setFunctionCode(null);
                        reader.next();

                        reader.next();
                    } else {
                        object.setFunctionCode(com.misyshealthcare.connect.doc.ccd.xsd.CodeSystem.Factory.parse(
                                reader));
