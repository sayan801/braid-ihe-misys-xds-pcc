...
/**
 *  CodeSystem bean class
 */
public class CodeSystem implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Code
     */
     ...
     *   in the serialized XML
     */
    protected boolean localCodeSystemTracker = false;
     ...
     *   in the serialized XML
     */
    protected boolean localCodeSystemNameTracker = false;
    ...
    public void setCodeSystemName(java.lang.String param) {
        if (param != null) {
            //update the setting tracker
            localCodeSystemNameTracker = true;
        } else {
            localCodeSystemNameTracker = true;
        }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    CodeSystem.this.serialize(parentQName, factory, xmlWriter);
                }
            };
        ...
        if (localCodeSystemNameTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "codeSystemName",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
    ...
    public static class Factory {
         ...
         */
        public static CodeSystem parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CodeSystem".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CodeSystem) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "codeSystem").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setCodeSystem(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "codeSystemName").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setCodeSystemName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
