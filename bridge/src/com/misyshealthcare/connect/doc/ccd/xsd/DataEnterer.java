...
/**
 *  DataEnterer bean class
 */
public class DataEnterer implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for AssignedEntityId
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.Id localAssignedEntityId;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localAssignedEntityIdTracker = false;
     ...
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.Id getAssignedEntityId() {
        return localAssignedEntityId;
    }

    /**
     * Auto generated setter method
     * @param param AssignedEntityId
     */
    public void setAssignedEntityId(
        com.misyshealthcare.connect.doc.ccd.xsd.Id param) {
        if (param != null) {
            //update the setting tracker
            localAssignedEntityIdTracker = true;
        } else {
            localAssignedEntityIdTracker = true;
        }

        this.localAssignedEntityId = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    DataEnterer.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localAssignedEntityIdTracker) {
            if (localAssignedEntityId == null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    xmlWriter.writeStartElement("assignedEntityId");
                }
                ...
                localAssignedEntityId.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd",
                        "assignedEntityId"), factory, xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localAssignedEntityIdTracker) {
            ...
            elementList.add((localAssignedEntityId == null) ? null
                                                            : localAssignedEntityId);
        }
    ...
    public static class Factory {
         ...
         */
        public static DataEnterer parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            DataEnterer object = new DataEnterer();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DataEnterer".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DataEnterer) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "assignedEntityId").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");

                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        object.setAssignedEntityId(null);
                        reader.next();

                        reader.next();
                    } else {
                        object.setAssignedEntityId(com.misyshealthcare.connect.doc.ccd.xsd.Id.Factory.parse(
                                reader));
