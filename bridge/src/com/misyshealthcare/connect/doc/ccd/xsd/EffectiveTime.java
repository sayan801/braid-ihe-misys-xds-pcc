...
/**
 *  EffectiveTime bean class
 */
public class EffectiveTime implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for End
     */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    EffectiveTime.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localEndTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://ccd.doc.connect.misyshealthcare.com/xsd", "end"));

            elementList.add((localEnd == null) ? null
                                               : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localEnd));
        }
        ...
        if (localStartTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://ccd.doc.connect.misyshealthcare.com/xsd", "start"));
    ...
    public static class Factory {
         ...
         */
        public static EffectiveTime parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EffectiveTime object = new EffectiveTime();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EffectiveTime".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EffectiveTime) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
