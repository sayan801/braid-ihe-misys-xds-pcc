...
/**
 * Title                :   
 * Description          :   This class is used to Transfer CCDData object from webservice request
 ...
 * Last Modified Date   :
 */
public class MapCCDData {
	/**
	 * Convert CCDData into the ccd package's CCDData
	 * @param wsData
	 * @param data
	 * @throws <code>CCDException</code> 
	 */
	public static void process(com.misyshealthcare.connect.doc.ccd.xsd.CCDData wsData, com.misyshealthcare.connect.doc.ccd.CCDData data) {
		if(wsData == null) return;
		
		data.setMetadata(MapMetaData.process(wsData.getMetadata()));
	}
