...
/**
 * Title                :   
 * Description          :   This class is used to Transfer ConsentDocumentData object from webservice request data object
 ...
 * Last Modified Date   :
 */
public class MapConsentDocumentData {

	/**
	 * Convert ConsentDocumentData into the ccd package's ConsentDocumentData
	 * @param wsConsDoc
	 * @param consDoc
	 * @throws CCDException
	 */
	public static void process(
			com.misyshealthcare.connect.doc.ccd.xsd.ConsentDocumentData wsConsDoc, ConsentDocumentData consDoc) {
		if(wsConsDoc == null) 
			return;
		
		MapScannedDocumentData.process(wsConsDoc, consDoc);
		consDoc.setConsentPolicies(TypeTransformerReqMetaData.convertConfidentialityCodes(wsConsDoc.getConsentPolicies()));
	}
}
