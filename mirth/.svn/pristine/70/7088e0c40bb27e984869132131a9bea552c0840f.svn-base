...
public class StandardConnectionDescription implements IConnectionDescription {
	protected static final Logger LOG = Logger.getLogger(StandardConnectionDescription.class);
	...
	public boolean complete() {
        ...
        if ( (hostName != null) ) {//&& (name != null) ) {
			complete = true;
		} else LOG.warn("Attempt to complete invalid standard connection description.");
		return complete;
	}
	
	/** Only used for init.  Not for use outside of factory. */
	public void setHostname(String hostName) {
		if (! complete) this.hostName = hostName; 
		else LOG.warn("Connection Descriptor setter used outside of factory.");
	}
	
	/** Only used for init.  Not for use outside of factory. */
	public void setPort(int port) {
		if (! complete) this.port = port;
		else LOG.warn("Connection Descriptor setter used outside of factory.");
	}

	/** Only used for init.  Not for use outside of factory. */
	public void setUrlPath(String urlPath) {
		if (! complete) this.urlPath = urlPath;
		else LOG.warn("Connection Descriptor setter used outside of factory.");
	}
	
	/** Only used for init.  Not for use outside of factory. */
	public void setName(String name) {
		if (! complete) this.name = name;
		else LOG.warn("Connection Descriptor setter used outside of factory.");
	}

	
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getHostname()
	 */
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getPort()
	 */
	public int getPort() {
		return port;
	}
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getUrlPath()
	 */
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getDescription()
	 */
	...
	public void addCodeSet(CodeSet codingScheme) {
		if (codingScheme != null) {
			...
			if (schemeName != null) {
				if (codingSchemes == null) codingSchemes = new Hashtable<String, CodeSet>();
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getProperty()
	 */
	...
	public void setProperty(String name, String value) {
		if (name != null) {
			if (value != null) {
				...
				if (properties != null) properties.remove(name.toLowerCase());
			}
		}
	}
	
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getPropertySet()
	 */
	...
	public void addPropertySet(PropertySet set) {
		if (set != null) {
			...
			if (setName != null) {
				if (propertySets == null) propertySets = new Hashtable<String, PropertySet>();
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getEnumMap()
	 */
	...
	public void addEnumMap(EnumMap enumMap) {
		if (enumMap != null) {
			...
			if (enumClass != null) {
				if (enumMaps == null) enumMaps = new Hashtable<Class, EnumMap>();
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getStringMap()
	 */
	...
	public void addStringMap(StringMap stringMap) {
		if (stringMap != null) {
			...
			if (mapName != null) {
				if (stringMaps == null) stringMaps = new Hashtable<String, StringMap>();
	...
	/* (non-Javadoc)
	 * @see com.misyshealthcare.connect.net.IConnectionDescription#getObjectMap()
	 */
	...
	public void addObjectMap(ObjectMap objectMap) {
		if (objectMap != null) {
			...
			if (mapName != null) {
				if (objectMaps == null) objectMaps = new Hashtable<String, ObjectMap>();
    ...
    /* (non-Javadoc)
    * @see com.misyshealthcare.connect.net.IConnectionDescription#getObject()
    */
    ...
    public void addObject(ObjectEntry object) {
        if (object != null) {
            ...
            if (mapName != null) {
                if (objects == null) objects = new Hashtable<String, ObjectEntry>();
    ...
    /* (non-Javadoc)
    * @see com.misyshealthcare.connect.net.IConnectionDescription#getObjectList()
    */
    ...
    public void addObjectList(ObjectList objectList) {
        if (objectList != null) {
            ...
            if (mapName != null) {
                if (objectLists == null) objectLists = new Hashtable<String, ObjectList>();
    ...
    /* (non-Javadoc)
      * @see com.misyshealthcare.connect.net.IConnectionDescription#getAssigningAuthority()
      */
