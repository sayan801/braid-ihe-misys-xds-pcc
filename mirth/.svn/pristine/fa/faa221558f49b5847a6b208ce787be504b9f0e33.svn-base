...
public class AddressType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final java.lang.String _WORK = org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
            "WORK");
    public static final AddressType HOME = new AddressType(_HOME, true);
    public static final AddressType OTHER = new AddressType(_OTHER, true);
    public static final AddressType UNKNOWN = new AddressType(_UNKNOWN, true);
    public static final AddressType WORK = new AddressType(_WORK, true);
    ...
    // Constructor
    protected AddressType(java.lang.String value, boolean isRegisterValue) {
        localAddressType = value;

        if (isRegisterValue) {
            _table_.put(localAddressType, this);
        }
    }
    ...
    public java.lang.String toString() {
        return localAddressType.toString();
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AddressType.this.serialize(MY_QNAME, factory, xmlWriter);
                }
            };
    ...
    public static class Factory {
        public static AddressType fromValue(java.lang.String value)
            ...
            AddressType enumeration = (AddressType) _table_.get(value);
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = AddressType.Factory.fromString(content,
                                    namespaceuri);
                        } else {
