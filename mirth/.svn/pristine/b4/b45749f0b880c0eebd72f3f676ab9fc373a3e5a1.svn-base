...
public class RimAxiom {
     ...
     */
    RimAxiom(String id, IConnectionDescription connection, Logger log) {
        this.id = id;
     ...
     */
    public static RimAxiom newXdsDocumentEntryBuilder(String id, IConnectionDescription connection, Logger log) {
        RimAxiom xml = new RimAxiom(id, connection, log);
     ...
     * @return The ebRIM XML builder
     */
    public static RimAxiom newXdsSubmissionSetBuilder(String id, IConnectionDescription connection, Logger log) {
        RimAxiom xml = new RimAxiom(id, connection, log);
     ...
     */
    public void addClassification(String codeType, String value, String classificationScheme, String classId, boolean isRequired) throws XdsRimException {
        if (value == null) {
            if (isRequired)
     ...
     * @throws XdsRimException  When the classification value does correspond to a known code
     */
    public void addClassification(String codeType, Collection<String> values, String classificationScheme, String classId, boolean isRequired) throws XdsRimException {
        if (values != null) {
            for (String value: values) {
                addClassification(codeType, value, classificationScheme, classId, isRequired);
            }
        } else if (isRequired) {
            throw new XdsRimException("Required classification \"" + codeType + "\" not supplied.");
        }
