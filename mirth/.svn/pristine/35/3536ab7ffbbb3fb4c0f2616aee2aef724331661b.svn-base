...
public class ObjectFactory
    extends com.misyshealthcare.connect.ihe.audit.jaxb.impl.runtime.DefaultJAXBContextImpl
{

    private static java.util.HashMap defaultImplementations = new java.util.HashMap(16, 0.75F);
    private static java.util.HashMap rootTagMap = new java.util.HashMap();
    public final static com.misyshealthcare.connect.ihe.audit.jaxb.impl.runtime.GrammarInfo grammarInfo = new com.misyshealthcare.connect.ihe.audit.jaxb.impl.runtime.GrammarInfoImpl(rootTagMap, defaultImplementations, (com.misyshealthcare.connect.ihe.audit.jaxb.ObjectFactory.class));
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.ActiveParticipantType createActiveParticipantType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.EventIdentificationType createEventIdentificationType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.AuditSourceIdentificationType createAuditSourceIdentificationType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.ParticipantObjectIdentificationType createParticipantObjectIdentificationType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.TypeValuePairType createTypeValuePairType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.AuditMessageType.ActiveParticipantType createAuditMessageTypeActiveParticipantType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.AuditMessageType createAuditMessageType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.ParticipantObjectIdentificationType.ParticipantObjectIDTypeCodeType createParticipantObjectIdentificationTypeParticipantObjectIDTypeCodeType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.AuditSourceIdentificationType.AuditSourceTypeCodeType createAuditSourceIdentificationTypeAuditSourceTypeCodeType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.CodedValueType createCodedValueType()
        throws javax.xml.bind.JAXBException
    {
     ...
     *     if an error occurs
     */
    public com.misyshealthcare.connect.ihe.audit.jaxb.AuditMessage createAuditMessage()
        throws javax.xml.bind.JAXBException
    {
