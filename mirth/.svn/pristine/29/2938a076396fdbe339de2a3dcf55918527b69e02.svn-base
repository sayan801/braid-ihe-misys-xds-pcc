...
/**
 * Test for 10512c PIX feed with ISO Affinity Domain
 *
 * @author Wenzhi Li
 * @version 2.0, Nov 17, 2006
 */
public class Test10512c {

 public static void main(String[] args) {
    String test = "10512c";
	MesaTestLogger logger = new MesaTestLogger("mesatests/submitted/10512/log10512c.txt");
