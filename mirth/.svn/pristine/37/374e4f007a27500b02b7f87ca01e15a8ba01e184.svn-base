 ...
 */
public class Test11950 {
	public static void main(String[] args) {
	    String test = "11950";
		MesaTestLogger log = new MesaTestLogger("mesatests/submitted/log11950.txt");
        ...
        try {	
            ...
            SOAPMessage reply = consumer.getMesaInterface().sendXdsRegistryQuery( query, "LeafClass", "true");
