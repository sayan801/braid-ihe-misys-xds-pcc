...
/**
 *  Participant bean class
 */
public class Participant implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Address
     * This was an Array!
     */
     ...
     * field for Id
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.Id localId;
    ...
    /**
     * field for PhoneNumbers
     * This was an Array!
     */
    protected com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[] localPhoneNumbers;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localPhoneNumbersTracker = false;
     ...
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.Id getId() {
        return localId;
    }
     ...
     * @param param Id
     */
    public void setId(com.misyshealthcare.connect.doc.ccd.xsd.Id param) {
        if (param != null) {
            //update the setting tracker
            localIdTracker = true;
        } else {
     ...
     */
    public com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[] getPhoneNumbers() {
        return localPhoneNumbers;
    }

    /**
     * validate the array for PhoneNumbers
     */
    protected void validatePhoneNumbers(
    ...
    public void setPhoneNumbers(
        com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[] param) {
        validatePhoneNumbers(param);

        if (param != null) {
            //update the setting tracker
            localPhoneNumbersTracker = true;
        } else {
            localPhoneNumbersTracker = true;
        }

        this.localPhoneNumbers = param;
    }
    ...
    public void addPhoneNumbers(
        ...
        if (localPhoneNumbers == null) {
            localPhoneNumbers = new com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[] {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPhoneNumbers);
        list.add(param);
        this.localPhoneNumbers = (com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[]) list.toArray(new com.misyshealthcare.connect.base.demographicdata.xsd.PhoneNumber[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Participant.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static Participant parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Participant".equals(type)) {
                            ...
                            return (Participant) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
