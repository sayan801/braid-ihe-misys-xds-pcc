...
public class TestBase implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setOrder(
        com.misyshealthcare.connect.base.clinicaldata.xsd.Order param) {
        if (param != null) {
            //update the setting tracker
    ...
    public static class Factory {
         ...
         */
        public static TestBase parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TestBase".equals(type)) {
                            ...
                            return (TestBase) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
