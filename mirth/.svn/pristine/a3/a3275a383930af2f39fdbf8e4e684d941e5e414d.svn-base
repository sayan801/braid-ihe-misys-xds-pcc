...
public class Code implements org.apache.axis2.databinding.ADBBean {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSystemTracker) {
            ...
            elementList.add((localSystem == null) ? null
                                                  : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localSystem));
        }
    ...
    public static class Factory {
         ...
         */
        public static Code parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Code".equals(type)) {
                            ...
                            return (Code) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setSystem(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
