...
/**
 *  ScannedDocumentData bean class
 */
public class ScannedDocumentData extends com.misyshealthcare.connect.doc.ccd.xsd.CCDData
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for MediaType
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.MediaType localMediaType;
     ...
     * @return com.misyshealthcare.connect.doc.ccd.xsd.MediaType
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.MediaType getMediaType() {
    ...
    public void setMediaType(
        com.misyshealthcare.connect.doc.ccd.xsd.MediaType param) {
        if (param != null) {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    ScannedDocumentData.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ScannedDocumentData", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ScannedDocumentData", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ScannedDocumentData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ScannedDocumentData object = new ScannedDocumentData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ScannedDocumentData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ScannedDocumentData) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
