...
/**
 *  SimpleProblem bean class
 */
public class SimpleProblem implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Code
     */
     ...
     * field for Status
     */
    protected com.misyshealthcare.connect.base.xsd.ClinicalStatusCode localStatus;
    ...
    /**
     * Auto generated getter method
     * @return com.misyshealthcare.connect.base.xsd.ClinicalStatusCode
     */
    public com.misyshealthcare.connect.base.xsd.ClinicalStatusCode getStatus() {
        return localStatus;
    }
    ...
    public void setStatus(
        com.misyshealthcare.connect.base.xsd.ClinicalStatusCode param) {
        if (param != null) {
            //update the setting tracker
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SimpleProblem.this.serialize(parentQName, factory, xmlWriter);
                }
            };
            ...
            if (localStatus == null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "status",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localStatusTracker) {
            ...
            elementList.add((localStatus == null) ? null : localStatus);
        }
    ...
    public static class Factory {
         ...
         */
        public static SimpleProblem parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SimpleProblem object = new SimpleProblem();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SimpleProblem".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SimpleProblem) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setStatus(com.misyshealthcare.connect.base.xsd.ClinicalStatusCode.Factory.parse(
                                reader));
