...
public class SubmissionSet implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public void setSubmissionSetMetaData(
        com.misyshealthcare.connect.doc.ccd.xsd.SubmissionSetMetaData param) {
        if (param != null) {
            //update the setting tracker
            ...
            if (localDocuments != null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "documents",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
            ...
            if (localSubmissionSetMetaData == null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2,
                            "submissionSetMetaData", namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2,
                ...
                localSubmissionSetMetaData.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd",
                        "submissionSetMetaData"), factory, xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSubmissionSetMetaDataTracker) {
            ...
            elementList.add((localSubmissionSetMetaData == null) ? null
                                                                 : localSubmissionSetMetaData);
        }
    ...
    public static class Factory {
         ...
         */
        public static SubmissionSet parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubmissionSet".equals(type)) {
                            ...
                            return (SubmissionSet) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list1.add(com.misyshealthcare.connect.doc.ccd.xsd.CCDDocument.Factory.parse(
                                reader));
                    }
                    ...
                    object.setDocuments((com.misyshealthcare.connect.doc.ccd.xsd.CCDDocument[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            com.misyshealthcare.connect.doc.ccd.xsd.CCDDocument.class,
                            list1));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "submissionSetMetaData").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setSubmissionSetMetaData(com.misyshealthcare.connect.doc.ccd.xsd.SubmissionSetMetaData.Factory.parse(
                                reader));
