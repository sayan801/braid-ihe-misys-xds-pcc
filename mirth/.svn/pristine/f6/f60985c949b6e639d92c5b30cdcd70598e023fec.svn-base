...
public class AuditCodeMappings {
	...
	public static AuditCodeMappings getCodeMapping(AuditTypeCodes id) {
		...
		case ProvideAndRegisterDocumentSet_b:
			codeMapping = new AuditCodeMappings("IHE Transactions", "ITI-41", "Provide & Register Document Set-b"); break;	
		}		
		return codeMapping;
	}
	...
	public static enum ParticipantObjectIdTypeCode {
		...
		Patient          ("2", ParticipantObjectTypeCode.Person),
		...
		Account          ("6", null),
		Guarantor        ("7", null),
		ReportName       ("8", ParticipantObjectTypeCode.SystemObject),
		ReportNumber     ("9", ParticipantObjectTypeCode.SystemObject),
		...
		PIXQuery         ("ITI-9", ParticipantObjectTypeCode.SystemObject, "PIX Query", "IHE Transactions"),
		PDQQuery         ("ITI-21", ParticipantObjectTypeCode.SystemObject, "PDQ Query", "IHE Transactions"),
		RegistryStoredQuery("ITI-18", ParticipantObjectTypeCode.SystemObject, "Registry Stored Query", "IHE Transactions"),
		RegistrySQLQuery ("ITI-16", ParticipantObjectTypeCode.SystemObject, "Registry SQL Query", "IHE Transactions"),
        //SubmissionSet IdTypeCode is defined in ITI V4 vol2 Section 3.15.4.1.4
		SubmissionSet    ("urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd", ParticipantObjectTypeCode.SystemObject);				
		private String value;
		private String name;
		private ParticipantObjectTypeCode type;
