 ...
 *  Test bean class
 */
public class Test extends com.misyshealthcare.connect.base.clinicaldata.xsd.TestBase
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Result
     * This was an Array!
     */
    protected com.misyshealthcare.connect.base.clinicaldata.xsd.Result[] localResult;
     ...
     * @return com.misyshealthcare.connect.base.clinicaldata.xsd.Result[]
     */
    public com.misyshealthcare.connect.base.clinicaldata.xsd.Result[] getResult() {
        return localResult;
    }
    ...
    protected void validateResult(
        com.misyshealthcare.connect.base.clinicaldata.xsd.Result[] param) {
    }
     ...
     * @param param com.misyshealthcare.connect.base.clinicaldata.xsd.Result
     */
    public void addResult(
        com.misyshealthcare.connect.base.clinicaldata.xsd.Result param) {
        if (localResult == null) {
            localResult = new com.misyshealthcare.connect.base.clinicaldata.xsd.Result[] {
        ...
        list.add(param);
        this.localResult = (com.misyshealthcare.connect.base.clinicaldata.xsd.Result[]) list.toArray(new com.misyshealthcare.connect.base.clinicaldata.xsd.Result[list.size()]);
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Test.this.serialize(parentQName, factory, xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":Test", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "Test", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static Test parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Test".equals(type)) {
                            ...
                            return (Test) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list3.add(com.misyshealthcare.connect.base.clinicaldata.xsd.Code.Factory.parse(
                                reader));
                    }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setOrder(com.misyshealthcare.connect.base.clinicaldata.xsd.Order.Factory.parse(
                                reader));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list6.add(com.misyshealthcare.connect.base.clinicaldata.xsd.Result.Factory.parse(
                                reader));
                    }
                    ...
                    // call the converter utility  to convert and set the array
                    object.setResult((com.misyshealthcare.connect.base.clinicaldata.xsd.Result[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            com.misyshealthcare.connect.base.clinicaldata.xsd.Result.class,
                            list6));
                } // End of if for expected property start element
