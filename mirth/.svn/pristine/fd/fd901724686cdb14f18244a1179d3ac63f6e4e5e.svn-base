...
/**
 *  Procedure bean class
 */
public class Procedure implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Code
     */
     ...
     */
    protected com.misyshealthcare.connect.base.xsd.StatusCode localStatusCode;
    ...
    /**
     * Auto generated getter method
     * @return com.misyshealthcare.connect.base.xsd.StatusCode
     */
    public com.misyshealthcare.connect.base.xsd.StatusCode getStatusCode() {
    ...
    public void setStatusCode(
        com.misyshealthcare.connect.base.xsd.StatusCode param) {
        if (param != null) {
            //update the setting tracker
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    Procedure.this.serialize(parentQName, factory, xmlWriter);
                }
            };
            ...
            if (localStatusCode == null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "statusCode",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2, "statusCode");
                    }
                } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localStatusCodeTracker) {
            ...
            elementList.add((localStatusCode == null) ? null : localStatusCode);
        }
    ...
    public static class Factory {
         ...
         */
        public static Procedure parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Procedure".equals(type)) {
                            ...
                            return (Procedure) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setStatusCode(com.misyshealthcare.connect.base.xsd.StatusCode.Factory.parse(
                                reader));
