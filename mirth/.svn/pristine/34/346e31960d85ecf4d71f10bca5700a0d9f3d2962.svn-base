...
/**
 *  EDReferralData bean class
 */
public class EDReferralData extends com.misyshealthcare.connect.doc.ccd.xsd.ReferralSummaryData
    implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for ProposedDisposition
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.ProposedDisposition localProposedDisposition;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localProposedDispositionTracker = false;

    /**
     * field for TransportMode
     */
    protected com.misyshealthcare.connect.doc.ccd.xsd.TransportMode localTransportMode;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localTransportModeTracker = false;
     ...
     * @return com.misyshealthcare.connect.doc.ccd.xsd.ProposedDisposition
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.ProposedDisposition getProposedDisposition() {
        return localProposedDisposition;
    }

    /**
     * Auto generated setter method
     * @param param ProposedDisposition
     */
    public void setProposedDisposition(
        com.misyshealthcare.connect.doc.ccd.xsd.ProposedDisposition param) {
        if (param != null) {
            //update the setting tracker
            localProposedDispositionTracker = true;
        } else {
            localProposedDispositionTracker = true;
        }

        this.localProposedDisposition = param;
    }

    /**
     * Auto generated getter method
     * @return com.misyshealthcare.connect.doc.ccd.xsd.TransportMode
     */
    public com.misyshealthcare.connect.doc.ccd.xsd.TransportMode getTransportMode() {
        return localTransportMode;
    }

    /**
     * Auto generated setter method
     * @param param TransportMode
     */
    public void setTransportMode(
        com.misyshealthcare.connect.doc.ccd.xsd.TransportMode param) {
        if (param != null) {
            //update the setting tracker
            localTransportModeTracker = true;
        } else {
            localTransportModeTracker = true;
        }

        this.localTransportMode = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    EDReferralData.this.serialize(parentQName, factory,
                        xmlWriter);
                }
            };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":EDReferralData", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "EDReferralData", xmlWriter);
        }
        ...
        if (localProposedDispositionTracker) {
            if (localProposedDisposition == null) {
                java.lang.String namespace2 = "http://ccd.doc.connect.misyshealthcare.com/xsd";
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2,
                            "proposedDisposition", namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2,
                    ...
                    xmlWriter.writeStartElement("proposedDisposition");
                }
                ...
                localProposedDisposition.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd",
                        "proposedDisposition"), factory, xmlWriter);
            }
        }

        if (localTransportModeTracker) {
            if (localTransportMode == null) {
                java.lang.String namespace2 = "http://ccd.doc.connect.misyshealthcare.com/xsd";
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "transportMode",
                            namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
                    } else {
                        xmlWriter.writeStartElement(namespace2, "transportMode");
                    }
                } else {
                ...
                localTransportMode.serialize(new javax.xml.namespace.QName(
                        "http://ccd.doc.connect.misyshealthcare.com/xsd",
                        "transportMode"), factory, xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localProposedDispositionTracker) {
            ...
            elementList.add((localProposedDisposition == null) ? null
                                                               : localProposedDisposition);
        }
        ...
        if (localTransportModeTracker) {
            ...
            elementList.add((localTransportMode == null) ? null
                                                         : localTransportMode);
        }
    ...
    public static class Factory {
         ...
         */
        public static EDReferralData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EDReferralData object = new EDReferralData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EDReferralData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EDReferralData) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "proposedDisposition").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");

                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        object.setProposedDisposition(null);
                        reader.next();

                        reader.next();
                    } else {
                        object.setProposedDisposition(com.misyshealthcare.connect.doc.ccd.xsd.ProposedDisposition.Factory.parse(
                                reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ccd.doc.connect.misyshealthcare.com/xsd",
                            "transportMode").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");

                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        object.setTransportMode(null);
                        reader.next();

                        reader.next();
                    } else {
                        object.setTransportMode(com.misyshealthcare.connect.doc.ccd.xsd.TransportMode.Factory.parse(
                                reader));
