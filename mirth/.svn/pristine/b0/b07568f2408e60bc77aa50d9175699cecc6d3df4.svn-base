            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PhoneNumber".equals(type)) {
                            ...
                            return (PhoneNumber) com.misyshealthcare.connect.doc.ccd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setType(com.misyshealthcare.connect.base.xsd.PhoneType.Factory.parse(
                                reader));
