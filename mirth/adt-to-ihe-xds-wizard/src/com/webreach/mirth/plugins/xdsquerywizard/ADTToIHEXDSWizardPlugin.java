 ...
 * 
 */
public class ADTToIHEXDSWizardPlugin extends ChannelWizardPlugin
{
    public ADTToIHEXDSWizardPlugin(String name) {
		super(name);
	}

	public static void main (String[] ignored) throws Exception {
        new ADTToIHEXDSWizardPlugin("wizard").runWizard();
    }
	...
	public Channel runWizard() {	
        ...
        Class[] pages = new Class[] {
            SourceConnectorPage.class, PatientIDMappingPage.class, DateRangePage.class, DestinationConnectorPage.class
        };
