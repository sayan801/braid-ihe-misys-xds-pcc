...
public class ConnectionCertificateHandler {
	private static final Logger LOG = Logger.getLogger(ConnectionCertificateHandler.class.getPackage().getName());
	...
	{
		if (keystore == null) throw new IllegalArgumentException("Keystore may not be null");
	...
	public static void main(String[] args) {
		...
		} catch (Exception e) { System.out.println("Top Level Error: " + e); }
	}
